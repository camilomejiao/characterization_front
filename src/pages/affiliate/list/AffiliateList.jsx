...
export const AffiliateList = () => {
    ...
    const normalizeRows = async (data) => {
        ...
        return data.map((row) => {
            return {
                ...
                lastName: row?.user?.firstLastName,
                middleLastName: row?.user?.middleLastName,
                ...
                sex: row?.user?.sex?.name,
                eps: row?.eps?.name,
                affiliatedState: row?.affiliatedState?.description,
    ...
    const AffiliateColumns = [
        ...
        {
            field: "affiliatedState",
            headerName: "Estado de Afiliación",
            width: 150,
            headerAlign: "left",
        },
        {
